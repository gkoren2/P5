...
conda_default_packages='pandas scikit-learn tqdm pyyaml'
...
pip_packages='transformers==4.2.1 sentencepiece tensorboard'
...
echo "at the end, copy the file to ${CONDA_PREFIX}"
